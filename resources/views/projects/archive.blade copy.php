        ...
        <div id="archive">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a  href="{{ route("projects") }}">active</a>&nbsp&nbsp&nbsp
                    <a style="font-weight:bold" href="{{ route("projects-archive") }}">trash</a>
                    {{-- TABLE --}}
                                    ...
                                    @foreach ($archive as $key=>$item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route("projects") }}/{{$item->id}}" method="POST">
                                                        @csrf
                                                        {{-- @method('DELETE') --}}
